...
@section('content')
    ...
    @component('components.banner.banner', ['href' => '/menedzher-po-prodazham/#manager-form', 'classes' => 'mrgn35 banner_bg'])
        @slot('title')
            Мы платим 10%<br/>
        ...
        @endslot
        @slot('icon')
          <img width="290" src="@asset('images/components/banners/Menedzher_po_prodazham_noskov_kolgotok.png')" alt="Менеджер по продажам носков и колготок">
        @endslot
    @endcomponent
    ...
    <div class="block-text">
        <div class="block-text__text block-text__text_padding-away">
            Fabrikanoskov.ru является производителем носочно-чулочных изделий. География наших клиентов весь мир. Носки
            нужны
            всем.
            <br/><br/>
            Наши мощности позволяют производить до 500 тысяч изделий в месяц. А на нашем складе хранится более 2 млн.
            изделий,
            готовых к реализации.
            <br/><br/>
            Также в нашем распоряжении отдел дизайна, который в кратчайшие сроки обрисует дизайн по любым желаниям
            клиента.
    ...
    <div class="block-text">
        ...
        <div class="block-text__text">
            Мы ищем коллег, которые нацелены на построение карьеры, улучшение своего финансового благополучия, при этом
            будучи
