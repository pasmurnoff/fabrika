...
@section('content')
  <div class="defaultpage">
    <div class="defaultpage__imgwrap">
      <img class="defaultpage__image" src="@asset('images/defaultpages/punk_vidachi_noskov.jpg')"
           alt="Пункты выдачи">
    </div>
    <div class="block-text">
      <div class="block-text__text block-text__text_bold">Способы доставки:</div>
      <ul class="block-text__list">
        <li class="block-text__point">Самовывоз</li>
        <li class="block-text__point">Автотранспотом поставщика</li>
        <li class="block-text__point">Доставка до любой транспортной компании за счет поставщика</li>
        <li class="block-text__point">
          Наложенным платежом «Почтой России» — стоимость доставки по РБ от 250руб, по РФ и странам таможенного союза –
          от 300руб. Срок доставки, согласно, графику поставок Почты России
        </li>
        <li class="block-text__point">Транспортными компаниями</li>
      </ul>

      <div class="block-text__text">
        До указанных ТК экспедирование бесплатно. Стоимость и сроки доставки до Вашего населенного пункта определяются
        ТК. Как правило на сайтах ТК есть эта информация. Доставка ТК осуществляется только после 100% оплаты на карту
        Сбербанка
      </div>

      <ul class="block-text__list">
        <li class="block-text__point">Курьерскими службами</li>
      </ul>
    </div>
  </div>
