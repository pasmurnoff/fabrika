<div class="footer__bottom">
    ...
    <div class="footer__privacy">
        ...
        веб-сайтом. «Cookie» представляют собой небольшие файлы, содержащие информацию о предыдущих посещениях
        веб-сайта.
        Если вы не хотите использовать файлы «cookie», измените настройки браузера.
        <br/><br/>
        © 2020 Фабрика Носков,ООО "Фабрика Носков", ИНН: 1655432469, КПП 165501001, ОРГН: 1201600008103
    </div>
    <ul class="menu footer__menu_bottom">
        <li class="menu__item">
