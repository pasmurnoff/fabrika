@component('components.banner.banner', ['classes' => 'banner__manager mrgn15', 'title' => 'Зарабатывай с нами! Платим 10% от суммы счета', 'href' => '/konstruktor-zakaza-noskov', 'buttonText' => 'Заказать носки' ])
    @slot('text')
