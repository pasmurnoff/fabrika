    ...
    <div class="defaultpage">
        ...
        <div class="block-text">
            <ul class="block-text__list">
                <li class="block-text__point">Создаете заявку на сайте, указывая форму оплаты и способ доставки и
                    получаете от
                    менеджера подтверждение того, что заказ принят, сумму к оплате и счет для оплаты.
                </li>
                <li class="block-text__point">Подтвержденный заказ можно оплатить в течении 5 суток. На этот срок
                    бронируется
                    товар на складе при его наличии, в противном случае товар поступает в производство (от 5 дней) при
                    наличии
                    необходимого сырья (в случае отсутствия необходимо сырья срок изготовления увеличивается до 21-45
                    дней).
                </li>
                <li class="block-text__point">Отгружаем товар НЕ ПОЗДНЕЕ 5-7 СУТОК с момента поступления денег на наш
                    счет, в
                    случае наличия товара на складе, в противном случае отталкиваемся от сроков производства.
        ...
        <div class="block-text">
            ...
            <div class="block-text__text">
                Если у Вас другой банк, то необходимо выбрать перевод юр.лицу/индивидуальному
                предпринимателю/организации и
