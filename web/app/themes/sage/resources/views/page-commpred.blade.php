...
@section('content')
  ...
  <div class="block-text pdng35">
    ...
    <div class="block-text__text block-text__text_padding-away">
      ...
      образца (1 пара носков), доставка опытного образца оплачивается клиентом отдельно при получении. Каждое изменение
  ...
  <div class="block-text">
    <div class="block-text__text block-text__text_padding-away">
      ...
      Состав: 80%, Эластан 17-20%, полиамид 2-3%,<br/>
      130 рублей за пару, сроки изготовления 14 календарных дней, после согласования дизайна;
    </div>
    <div class="threeimage">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_0163.jpg')"
           alt="Стоимость 100 пар гладких носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_0159.jpg')"
           alt="Стоимость 100 пар гладких носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_0177.jpg')"
           alt="Стоимость 100 пар гладких носков">
    </div>
  </div>
  ...
  <div class="block-text">
    ...
    <div class="threeimage">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_3259.jpg')"
           alt="Стоимость 1000 пар гладких носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_3255.jpg')"
           alt="Стоимость 1000 пар гладких носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_3201.jpg')"
           alt="Стоимость 1000 пар гладких носков">
    </div>
  </div>
  ...
  <div class="block-text">
    ...
    <div class="threeimage">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_5469.jpg')"
           alt="Стоимость 100 пар спортивных носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_0265.jpg')"
           alt="Стоимость 100 пар спортивных носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_3092.jpg')"
           alt="Стоимость 100 пар спортивных носков">
    </div>
  </div>
  ...
  <div class="block-text">
    ...
    <div class="threeimage">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_5473.jpg')"
           alt="Стоимость 1000 пар спортивных носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_5477.jpg')"
           alt="Стоимость 1000 пар спортивных носков">
      <img class="threeimage__image" src="@asset('images/blocks/kommpred/IMG_9292.jpg')"
           alt="Стоимость 1000 пар спортивных носков">
    </div>
  </div>
