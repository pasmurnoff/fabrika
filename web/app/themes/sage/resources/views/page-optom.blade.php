  ...
  <div class="defaultpage">
    ...
    <div class="block-text">
      <div class="block-text__text">
        Fabrikanoskov.ru всегда готова к сотрудничеству и рада новым партнерам. Ассортимент фабрики более 500 моделей
      ...
      <br/>
      <div class="block-text__text">
        От 3 до 7 дней, в зависимости от сложности. Сроки производства носков с логотипом, при наличии пряжи на складе
      ...
      <div class="block-text__text block-text__text_bold">
        Дополнительно предлагаем <a class="block-text__link" href="/etiketka-i-upakovka-noskov">услугу упаковки</a> с
      ...
      <br/>
      <div class="block-text__text">
        Можно быть уверенным в том, что товар не потеряется в пути, а время доставки не увеличится из-за недостаточно
      ...
      <br/>
      <div class="block-text__text">
        <a class="block-text__link" href="/konstruktor-zakaza-noskov">Создаете заявку на сайте</a>, указывая форму
        ...
        счет. Предоставляем полный пакет документов: договор, счет, сертификаты, накладные. Напоминаем плательщикам
        НДС,
        что мы работаем по упрощенной системе налогообложения — без НДС.
      </div>
      <br/>
      <div class="block-text__text block-text__text_bold">
        <a class="block-text__link block-text__link_bold" href="/uslovija-oplaty">Способы оплаты</a> для физических
        лиц
      </div>
      ...
      <div class="block-text__text">
        ...
        проконсультироваться по бесплатному телефону <a class="block-text__link" href="tel:88004441156">8 800 444 11
          56</a>
      </div>
    </div>
