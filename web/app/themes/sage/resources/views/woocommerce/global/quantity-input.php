...
if ($max_value && $min_value === $max_value) {
    ...
    ?>
    <div class="quantity number product__counter">
        <?php do_action('woocommerce_before_quantity_input_field'); ?>
        <span class="qty-minus number__counter number__counter_minus"
              onclick="this.parentNode.querySelector('input[type=number]').stepDown()">–</span>
        <input
                type="number"
                id="<?php echo esc_attr($input_id); ?>"
                class="input input_number <?php echo esc_attr(join(' ', (array)$classes)); ?>"
        ...
        <span class="qty-plus number__counter number__counter_plus"
