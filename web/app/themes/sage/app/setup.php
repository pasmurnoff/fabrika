...
add_action('widgets_init', function () {
    ...
    register_sidebar([
        ...
        'id' => 'cart-sidebar',
        'before_widget' => '<div class="mini-cart %1$s %2$s"><div class="mini-cart__cross closeminicart" data-minicart="mini-cart"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg"
